...
(function(mifosX) {
  var defineRoutes = function($routeProvider, $locationProvider) {
    $routeProvider
     ...
     .when('/assets', {
        templateUrl: 'views/organization/assets.html'
      })
         .when('/createasset', {
        templateUrl: 'views/organization/createasset.html'
      })
     ...
     .when('/viewasset/:id', {
        templateUrl: 'views/organization/viewasset.html'
      })
    .when('/insurar/:id', {
        templateUrl: 'views/organization/insurar.html'
      })
      .when('/editasset/:id', {
        templateUrl: 'views/organization/editasset.html'
      })
